class Gw < Formula
  ...
  url "https://github.com/v-gutierrez/gw/archive/refs/tags/v0.7.0.tar.gz"
  sha256 "5dd05d8bd13cd41e4a24322bc95be9c718089c843da874ca5f7f83a99cafe77d"
  license "MIT"
  ...
  test do
    assert_match "0.5.2", shell_output("#{bin}/gw --version")
  end
end
